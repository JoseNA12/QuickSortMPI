...
#define N 20000000   // cantidad de numeros aleatorios a generar
#define X 1000  // tope de numero a generar
...
//      printf("%d ", fullArr[i]);
    ...
    printf("\nTiempo requerido: %lf segundos", end-start);
    printf("\nCantidad de números: %d", N);
    printf("\nCantidad de nodos: %d\n", size);
    free((void *) fullArr);
    free((void *) sizeArr);
